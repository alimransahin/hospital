  ...
  $.extend(CubePortfolio.prototype, {
    ...
    responsiveLayout: function () {
      ...
      t.blocks.each(function (index, el) {
        ...
        $.each(
          block.find("img").filter("[width][height]"),
          function (index, el) {
            ...
            imgs.push({
              ...
              width: width,
              height: Math.floor(
                parseInt(el.getAttribute("height"), 10) * procent
              ),
            });
          }
        );
    ...
    getColumnsBreakpoints: function () {
      ...
      if (columns === undefined) {
        columns =
          t.options.mediaQueries[t.options.mediaQueries.length - 1].cols;
      }
...
(function ($, window, document, undefined) {
  ...
  CubePortfolio.public = {
    ...
    destroy: function (callback) {
      ...
      if (t.options.caption) {
        t.$obj.removeClass(
          "cbp-caption-active cbp-caption-" + t.options.caption
        );
      }
    ...
    t.loadMore.on("click.cbp", function (e) {
      ...
      $.ajax({
        ...
        .done(function (result) {
          ...
          var endBlock = items.indexOf(
            "cbp-loadMore-block" + (numberOfClicks + 1)
          );
          var end;
        ...
        getNewItems: function () {
          ...
          $.ajax({
            ...
            .done(function (result) {
              ...
              var startBlock = items.indexOf(
                "cbp-loadMore-block" + self.numberOfClicks
              );
              ...
              var endBlock = items.indexOf(
                "cbp-loadMore-block" + (self.numberOfClicks + 1)
              );
              var end;
    ...
    openSinglePage: function (blocks, currentBlock) {
      ...
      t.wrap.one(CubePortfolio.private.transitionend, function () {
        ...
        if (t.options.singlePageStickyNavigation) {
          ...
          if (
            CubePortfolio.private.browser === "android" ||
            CubePortfolio.private.browser === "ios"
          ) {
            // wrap element
      ...
      body.on("click.cbp", p.options.lightboxDelegate, function (e) {
        ...
        if (cbp) {
          cbp.blocksOn.each(function (index, el) {
            ...
            if (item.not(".cbp-item-off")) {
              item
                .find(p.options.lightboxDelegate)
                .each(function (index2, el2) {
                  if (gallery) {
